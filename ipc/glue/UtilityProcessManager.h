 ...
 private:
  ...
  class ProcessFields final {
   public:
    ...
    // (see StartHWInference); always 0 for kinds that only ever have one.
  ...
  // Not indexed by SandboxingKind: some kinds (see StartHWInference) can have
  // more than one live process at a time, distinguished by mInstanceKey.
