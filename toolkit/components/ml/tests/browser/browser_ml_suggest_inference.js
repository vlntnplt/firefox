...
const runInference2 = async ({ backend, tag }) => {
  ...
  // to the same backend as the primaries, otherwise MLSuggest silently falls
  // back from "onnx-native" to "onnx" and the run no longer measures what its
  // tag says.
