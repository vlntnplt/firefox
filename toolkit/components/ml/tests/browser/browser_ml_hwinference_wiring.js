...
// Wiring of the HWInference routing seam: download notifications reach the
// caller's notificationsCallback with the ModelHub payload shape, and the
// caller's AbortSignal reaches (or short-circuits) the model download. The
// hub is stubbed; no model is downloaded and no utility process spawns.
