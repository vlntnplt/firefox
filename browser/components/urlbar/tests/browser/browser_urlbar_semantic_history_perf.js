  ...
  options: {
    default: {
      ...
      perfherder_metrics: [
        ...
        {
          name: "SEMANTICHISTORY-engine-creation",
          unit: "ms",
          shouldAlert: false,
        },
        {
          name: "SEMANTICHISTORY-inference-time",
          unit: "ms",
          shouldAlert: false,
        },
        {
          name: "SEMANTICHISTORY-input-tokens",
          unit: "tokens",
          shouldAlert: false,
        },
        {
          name: "SEMANTICHISTORY-tokens-per-second",
          unit: "tokens/s",
          shouldAlert: false,
        },
      ],
...
add_task(async function test_semantic_history_perf() {
  ...
  async function buildIndexOnce() {
    ...
    const spans = {};
    spans[INDEX_BUILD_LATENCY] = performance.now() - start;
    return spans;
  }
  ...
  async function searchOnce() {
    ...
    const spans = {};
    spans[SEMANTIC_RESULT_LATENCY] = latency;
    return spans;
  }
