...
::
 ...
 --perfherder
 --perfherder-metrics name:pipeline-ready-latency,unit:ms,shouldAlert:False, name:initialization-latency,unit:ms,shouldAlert:False, name:model-run-latency,unit:ms,shouldAlert:False, name:total-memory-usage,unit:MiB,shouldAlert:False, name:tokenSpeed,unit:tokens/s,shouldAlert:False,lowerIsBetter:False, name:charactersSpeed,unit:chars/s,shouldAlert:False,lowerIsBetter:False, name:concurrent-init-latency,unit:ms,shouldAlert:False, name:e2e-run-latency,unit:ms,shouldAlert:False
 --verbose
 --manifest perftest.toml
 --manifest-flavor browser-chrome
 --try-platform linux, mac, win
